## original file from: https://github.com/petered/plato/blob/36f44d7385ed78047aef558ab5dc228b63651b73/fileman/disk_memoize.py
...
def compute_fixed_hash(obj, hasher = None):
    ...
    if isinstance(obj, (int, str, float, bool,unicode) or obj is None):
